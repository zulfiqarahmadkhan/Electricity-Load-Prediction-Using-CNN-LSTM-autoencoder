...
from keras.layers import   RepeatVector, Flatten, MaxPooling1D, LSTM
...
#Proposed CNN-LSTM-AE model
model = Sequential()
model.add(Conv1D(filters=8, kernel_size=3, activation='relu', input_shape=(8,1)))
...
print(model.summary())
model.fit(trainX, trainY, epochs=50, validation_split=0.2, batch_size=100)

#Saving the mdoel weights
